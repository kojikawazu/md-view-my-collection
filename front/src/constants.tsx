...
export const INITIAL_REPORTS: ReportItem[] = [
  {
    ...
    summary:
      'An exploration of how clean lines and neutral palettes are evolving in the 2025 landscape.',
    content:
  ...
  },
  {
    ...
    summary:
      'Analyzing the impact of distributing high-quality reports across decentralized networks.',
    content:
